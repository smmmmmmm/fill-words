...
function Top() {
    ...
    <Grid container spacing={2} alignItems="flex-start" justify="center">
        <Grid item xs={10}>
            ...
            昨今の謎解きの一部の競技シーンでは都道府県を暗記していることで素早く解ける問題がある<sup>[要出典]</sup>らしいので、
            都道府県の穴埋め問題をスラスラ解けるようになると嬉しいなという練習用のサイトです<br></br>
            一般的に謎解きを楽しむ分には全く必要のない技能で、将来的にもこの技能が謎解きの水準になることは来ないし、
            何なら某テレビで既に 2 回くらい使われたネタなのであんまり競技シーンでも必要となることはなさそうな気がしますが、それでもやりたい方は上からどうぞ。

            <h3> 問題形式 </h3>
                共通
                <ul>
                    <li>「さ？？？」 のように一部の平仮名が ? となっている問題が出題されるので、当てはまる都道府県を平仮名で書いて回答します。 </li>
                    <li>「と？？」の場合は 「とやま」「とちぎ」のように、解が複数ある問題は過不足なく答える必要があります。 </li>
            ...
            <h3> 改善要望 </h3>
            改善要望があれば <a target="_brank" href='https://twitter.com/smmm4423'> @smmmm4423 </a> に投げるとそのうち改善されるかもしれません。<br></br>
            もしくは <a target="_brank" href="https://github.com/smmmmmmm/fill-words"> PR か Issue </a> たててくれれば対応されるかもしれません。当方フロントサイド詳しくないのでまさかり歓迎です

            <h3> Release Note </h3>
            <a target="_brank" href="https://github.com/smmmmmmm/fill-words/releases"> releases </a>
